...
INFLUXDB_TOKEN = "BVu7JGnIRGgNx9hcwKhZKJijZCqC2_tAgdHA-HFkrxDHG4kibwtVnANFI8DPN8NpgY1sScQme1VPLP9SdvlsdA=="  # Replace with your InfluxDB token
INFLUXDB_ORG = "adifa1338"      # Replace with your InfluxDB organization name
INFLUXDB_BUCKET = "ESP32"  # InfluxDB bucket name

# MQTT setup
MQTT_BROKER = "192.168.1.11"  # ESP32's MQTT broker address
